...
import BeerIcon from '~/assets/svg/beer-icon.svg?react';
import BeverageIcon from '~/assets/svg/beverage-icon.svg?react';
import BiscuitIcon from '~/assets/svg/biscuits-icon.svg?react';
import LibraryIcon from '~/assets/svg/book-icon.svg?react';
import BreadIcon from '~/assets/svg/bread-icon.svg?react';
import BreakfastIcon from '~/assets/svg/breakfast-icon.svg?react';
import CannedFoodIcon from '~/assets/svg/canned-food-icon.svg?react';
import ClothesIcon from '~/assets/svg/clothes-icon.svg?react';
import CreamIcon from '~/assets/svg/cream-icon.svg?react';
import DessertIcon from '~/assets/svg/dessert-icon.svg?react';
import FishIcon from '~/assets/svg/fish-icon.svg?react';
import FreshIcon from '~/assets/svg/fresh-icon.svg?react';
import FrozenIcon from '~/assets/svg/frozen-icon.svg?react';
import FruitIcon from '~/assets/svg/fruit-icon.svg?react';
import GroceryIcon from '~/assets/svg/grocery-icon.svg?react';
import HealthIcon from '~/assets/svg/health-icon.svg?react';
import HomeCleaningIcon from '~/assets/svg/home-cleaning-icon.svg?react';
import HygieneIcon from '~/assets/svg/hygiene-icon.svg?react';
import MeatIcon from '~/assets/svg/meat-icon.svg?react';
import MusicIcon from '~/assets/svg/music-icon.svg?react';
import OilsAndVinegarIcon from '~/assets/svg/olive-oil-icon.svg?react';
import SpiceIcon from '~/assets/svg/spice-icon.svg?react';
import WineIcon from '~/assets/svg/wine-icon.svg?react';
import WorldCuisineIcon from '~/assets/svg/world-cuisine-icon.svg?react';
